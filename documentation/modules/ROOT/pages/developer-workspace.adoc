...
:USER_ID: %USER_ID%
:DEVSPACES: %2Ddevspaces
:DEVNAMESPACE: user{USER_ID}{DEVSPACES}
:DEVNAMESPACE2: user{USER_ID}%2Ddevspaces
:DEVNAMESPACE3: user{USER_ID}devspaces
...
[link={CHE_URL}/dashboard/#/ide/{DEVNAMESPACE}/wksp-end-to-end-dev]
// Default IDE
