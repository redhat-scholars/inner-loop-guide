...
In your {CHE_URL}[Workspace^, role='params-link'], `*click on 'Terminal' -> 'Run Task...' ->  'Catalog - Build'*`

image::che-runtask.png[Che - RunTask, 500]

image::che-catalog-build.png[Che - Catalog Build, 500]
...
image::che-catalog-run.png[Che - Catalog Run, 500]
...
In your {CHE_URL}[Workspace^, role='params-link'], stop the service by `*hitting Ctrl+c in the '>_ Catalog - Run' Terminal*`
