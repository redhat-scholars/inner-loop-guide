...
Now, let's run your service using **Spring Boot maven plugin** and test the endpoint. 
...
When pop-ups appear, *confirm you want to expose the 9000 port* by `*clicking on 'Open in Preview'*`.
