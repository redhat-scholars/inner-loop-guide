...
+
-- 
`*Click on 'Terminal' -> 'Run Task...' ->  'che: Catalog - Build'*`
...
+
-- 
`*Click on 'Terminal' -> 'Run Task...' ->  'che: Catalog - Run'*`
...
+
-- 
`*Click on 'Terminal' -> 'Run Task...' ->  'che: Catalog - Create Component'*`

Then, `*click on 'Terminal' -> 'Run Task...' ->  'che: Catalog - Push'*`
