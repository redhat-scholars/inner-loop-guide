...
image::images/coolstore-arch-gateway-dotnet.png[FIXME CoolStore Architecture,400]
...
image::images/dotnet-gateway-project.png[FIXME Gateway Project,340]
...
image::images/xxxxopenshift-gateway-topology.png[FIXME OpenShift - Gateway Topology, 700]

Your browser will be redirect on **your Gateway Service running on OpenShift**.

image::images/xxxgateway-service.png[FIXME Gateway Service,500]
