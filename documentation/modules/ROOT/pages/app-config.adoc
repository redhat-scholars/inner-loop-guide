...
OpenShift provides a mechanism called https://docs.openshift.com/container-platform/4.9/welcome/index.html[**ConfigMaps**^] 
...
Let's create a https://docs.openshift.com/container-platform/4.9/welcome/index.html[MariaDB database^] 
...
called https://docs.openshift.com/container-platform/4.9/welcome/index.html[**Secrets**^]. Secret objects act and are used 
