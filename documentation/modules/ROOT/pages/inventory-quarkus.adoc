...
Devfile Object Validation
 ✓  Checking devfile existence [48252ns]
 ✓  Creating a devfile component from registry: DefaultDevfileRegistry [94003ns]
Validation
 ✓  Validating if devfile name is correct [19771ns]
...
[TIP]
====
Now the configuration file **'env.yaml'** is in the local directory of the inventory component 
(**'/projects/workshop/labs/inventory-quarkus/.odo/env'**) that contains information about the component for deployment.
====
...
----
Validation
 ✓  Validating the devfile [96053ns]
...
Applying URL changes
 ✓  URL 8080-tcp: http://8080-tcp-coolstore-my-project{USER_ID}.{APPS_HOSTNAME_SUFFIX}/ created
...
Executing devfile commands for component inventory
 ✓  Executing build command "mvn clean -Dmaven.repo.local=/home/user/.m2/repository package -Dmaven.test.skip=true" [2m]
