...
It’s time to use https://docs.openshift.com/container-platform/4.9/cli_reference/developer_cli_odo/understanding-odo.html[odo^] 
to deploy your service on OpenShift using
https://docs.openshift.com/container-platform/4.9/cli_reference/developer_cli_odo/understanding-odo.html[devfiles^].
