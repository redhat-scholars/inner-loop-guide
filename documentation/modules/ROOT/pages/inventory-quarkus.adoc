...
In your {CHE_URL}[Workspace^, role='params-link'], `*click on 'Terminal' -> 'Run Task...' ->  'Inventory - Compile (Dev Mode)'*`

image::che-runtask.png[Che - RunTask, 500]

image::che-inventory-compile.png[Che - Inventory Development Mode, 500]
...
In your {CHE_URL}[Workspace^, role='params-link'], stop the service by `*hitting Ctrl+c in the '>_ Inventory Compile (Dev Mode)' Terminal*`
...
https://docs.openshift.com/container-platform/4.6/cli_reference/developer_cli_odo/understanding-odo.html[odo^] (OpenShift Connector Plugin) is a 
fast, iterative, and straightforward CLI tool for developers who write, build, and deploy applications on Kubernetes and OpenShift.

In your {CHE_URL}[Workspace^, role='params-link'], `*click on 'Terminal' -> 'Run Task...' ->  'Inventory - Build'*`

image::che-runtask.png[Che - RunTask, 500]

image::che-inventory-build.png[Che - Build Inventory, 500]

Once this completes, let's **push** your application into OpenShift.

In your {CHE_URL}[Workspace^, role='params-link'], from **'OpenShift' View**, 
`*right-click on your 'my-project{USER_ID}' project and select 'New Component'*`

image::che-openshift-new-component.png[Che - OpenShift New Component, 400]
...
|Select binary file
|$(file-zip) target/inventory-quarkus-1.0.0-SNAPSHOT-runner.jar
...
image::che-openshift-push-inventory.png[Che - OpenShift Push Inventory, 400]
...
image::che-openshift-url-inventory.png[Che - OpenShift URL Inventory, 400]
