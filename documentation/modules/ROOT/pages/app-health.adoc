...
+
-- 
`*Click on 'Terminal' -> 'Run Task...' ->  'devfile: Catalog - Generate Traffic'*`
...
In your {CHE_URL}[Workspace^, role='params-link'], `*click on 'Terminal' -> 'Run Task...' ->  'devfile: Catalog - Add PodAffinity'*`
