...
+
-- 
`*Click on 'Terminal' -> 'Run Task...' ->  'che: Catalog - Generate Traffic'*`
...
In your {CHE_URL}[Workspace^, role='params-link'], `*click on 'Terminal' -> 'Run Task...' ->  'che: Catalog - Add PodAffinity'*`
...
In your {CHE_URL}[Workspace^, role='params-link'], `*click on 'Terminal' -> 'Run Task...' ->  'che: Probes - Configure Gateway & Web'*`
